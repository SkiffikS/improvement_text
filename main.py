...
if __name__ == "__main__":
    ...
    text = "Кни́га — неперіодичне видання у вигляді зброшурованих \
    аркушів друкованого матеріалу, набір письмових, друкованих, \
    ілюстрованих або порожніх аркушів, виготовлених з паперу, \
    пергаменту або іншого матеріалу, як правило, скріплених з одного боку. \
    Сторони аркуша називаються сторінками. Книга виготовлена в цифровому вигляді \
    називається електронною книгою. Озвучену й записану на матеріальний носій \
    книгу називають аудіокнигою (звуковою книгою, книгою вголос). \
    Книжкова крамниця або книгарня — крамниця, де продаються книги. \
    Також книги можна позичати у бібліотеках на певний час."
    a = synonymizer(text)
    print(a)